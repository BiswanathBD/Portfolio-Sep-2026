...
const HeroSection = () => {
  ...
  return (
    <>
      ...
      {/* section */}
      <section className="min-h-screen flex flex-col justify-center pb-2 lg:pb-4">
        <Header />

        <div
          className="relative py-6 lg:py-0 grow grid items-center mt-44 sm:mt-22 lg:-mt-22"
