    ...
    <>
      ...
      >
        <header className="flex items-center justify-between py-2 px-3 rounded-2xl border border-border-color/60 bg-linear-to-br from-card-bg to-primary/10 backdrop-blur-sm shadow-2xl">
          ...
          <button
            ...
            className="flex size-10 cursor-pointer items-center justify-center rounded-lg border border-primary/10 bg-linear-to-br from-primary/10 to-accent/10"
          >
      ...
      >
        ...
        <motion.aside
          ...
          className={`relative flex h-screen flex-col bg-background/95 backdrop-blur-sm sm:bg-background/20 sm:backdrop-blur-[1px] py-6 select-none transition-transform duration-300 ease-out sm:relative sm:translate-x-0 ${
            isOpen
